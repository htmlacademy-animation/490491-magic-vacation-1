...
/* harmony import */ var _accent_typography_builder__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./accent-typography-builder */ "./source/js/modules/accent-typography-builder.js");
...
class FullPageScroll {
  constructor() {
    ...
    this.introTitle = new _accent_typography_builder__WEBPACK_IMPORTED_MODULE_1__["default"](`.intro__title`, 500, `accent-typography--active`, `transform`, 300);
    this.storyTitle = new _accent_typography_builder__WEBPACK_IMPORTED_MODULE_1__["default"](`.slider__item-title`, 500, `accent-typography--active`, `transform`, 300);
    this.prizesTitle = new _accent_typography_builder__WEBPACK_IMPORTED_MODULE_1__["default"](`.prizes__title`, 500, `accent-typography--active`, `transform`, 300);
    this.rulesTitle = new _accent_typography_builder__WEBPACK_IMPORTED_MODULE_1__["default"](`.rules__title`, 500, `accent-typography--active`, `transform`, 300);
    this.gameTitle = new _accent_typography_builder__WEBPACK_IMPORTED_MODULE_1__["default"](`.game__title`, 500, `accent-typography--active`, `transform`, 300);  
    this.introDate = new _accent_typography_builder__WEBPACK_IMPORTED_MODULE_1__["default"](`.intro__date`, 500, `accent-typography--active`, `transform`);      
  }
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  let screenBg = document.querySelector(`.js-screen-bg`);
  ...
  for (let i = 0; i < menuLinks.length; i++) {
    menuLinks[i].addEventListener(`click`, function () {
      ...
      if (this.dataset.href === `prizes`) {
        screenBg.classList.add(`animate`);
        setTimeout(()=>{
          screenBg.classList.remove(`animate`);
        }, 1000);
      }
    });
  }
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  const setActiveTheme = function (name) {
    bodyEl.classList.remove('page-load--purple');
    bodyEl.classList.remove('page-load--blue');
    bodyEl.classList.remove('page-load--light-blue');
        ...
        on: {
          slideChange: () => {
            if (storySlider.activeIndex === 0 || storySlider.activeIndex === 1) {
              sliderContainer.style.backgroundImage = `url("img/slide1.jpg"), linear-gradient(180deg, rgba(83, 65, 118, 0) 0%, #523E75 16.85%)`;
              setActiveTheme('page-load--purple');
              ...
              setActiveTheme('page-load--light-blue');
...
/* harmony import */ var _modules_page_load__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/page-load */ "./source/js/modules/page-load.js");
// modules
...
Object(_modules_page_load__WEBPACK_IMPORTED_MODULE_9__["default"])();
